...
type TimbreFiscalDigital struct {
	TimbreFiscalDigital11 *TimbreFiscalDigital11 `bson:"TimbreFiscalDigital11,omitempty" json:"TimbreFiscalDigital11,omitempty"`
	TimbreFiscalDigital10 *TimbreFiscalDigital10 `bson:"TimbreFiscalDigital10,omitempty" json:"TimbreFiscalDigital10,omitempty"`
}
