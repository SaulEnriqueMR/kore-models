...
func InternalTestBaseVehiculoUsado(t *testing.T, vehiculo vehiculousado1.VehiculoUsado10) {
	...
	assert.Equal(t, "1HGBH41JXMN109186", *vehiculo.NoMotor)
	assert.Equal(t, "2HGBH41JXMN109186", *vehiculo.NoSerie)
	assert.Equal(t, "JTHBJ46G992109186", *vehiculo.NoIdentificacionVehicular)
